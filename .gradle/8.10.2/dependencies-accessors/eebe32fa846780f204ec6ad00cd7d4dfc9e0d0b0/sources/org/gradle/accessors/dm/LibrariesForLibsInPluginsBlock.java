...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxComposeUiTestLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>composeUiTestJunit4</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class PlayLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>integrity</b> with <b>com.google.android.play:integrity</b> coordinates and
         * with version reference <b>playIntegrity</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getIntegrity() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("play.integrity");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>accompanistPermissions</b> with value <b>0.37.0</b>
         * <p>
        ...
        /**
         * Version alias <b>composeUiTestJunit4</b> with value <b>1.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getComposeUiTestJunit4() { return getVersion("composeUiTestJunit4"); }
        ...
        /**
         * Version alias <b>playIntegrity</b> with value <b>1.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlayIntegrity() { return getVersion("playIntegrity"); }
    ...
    public static class ComposeBundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>compose.debug</b> which contains the following dependencies:
         * <ul>
        ...
        /**
         * Dependency bundle provider for <b>compose.ui</b> which contains the following dependencies:
         * <ul>
        ...
        public Provider<ExternalModuleDependencyBundle> getUi() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return createBundle("compose.ui");
        }
